    ...
    <div class="modal-body" style="padding:16px 22px;">
        ...
        <div id="sec-cash">
            ...
            <div style="display:flex;gap:6px;margin-top:10px;">
                <?php $__currentLoopData = [5,10,20,50]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button onclick="setCash(<?php echo e($a); ?>)" class="cash-tile">£<?php echo e($a); ?></button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
function loadCats() {
    ...
    fetch('/pos/api/categories')
        .then(r=>r.json())
        .then(data => {
            if (!data.length) { setGrid('<div class="text-center text-secondary py-5" style="opacity:.5;"><div style="font-size:36px;">📭</div><div class="mt-2 small">No stock yet. <a href="<?php echo e(route("pos.stock")); ?>">Add stock →</a></div></div>'); return; }
